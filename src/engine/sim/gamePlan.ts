...
export const GAME_PLANS: readonly GamePlanDefinition[] = [
	...
	},
	{
		...
		hint: "Win the duel, then the round.",
	...
	},
	{
		...
		hint: "Utility first, then the site.",
	...
	},
	{
		...
		hint: "Call the counter, not the default.",
		favoredStyles: ["tactical"],
	...
	},
	{
		id: "risky",
		label: "Risky plays",
		tSide: "Push the smokes. Dry peek, take the gamble.",
		ctSide: "Jump peek, push their smoke, gamble the stack.",
		hint: "Flip the round or bleed it.",
		favoredStyles: ["aim", "hybrid"],
		attributes: { entry: 7, aim: 4, consistency: -8, clutch: -6, igl: -4, utility: -2 },
		antiStrat: -6,
		economyDiscipline: -8,
		chemistry: 0,
		pistolBias: 0.01,
		earlyRoundBias: 0.014,
	},
] as const;
